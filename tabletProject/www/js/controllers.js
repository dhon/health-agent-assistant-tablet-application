angular.module('app.controllers', [])
  ...
  .controller('septicFormCtrl', function($scope) {
    $scope.printReport = function(septic) {
      console.log('printing');
      console.log(septic);

      var docDefinition = {
	content: [
	  { text: 'System Pumping Record', style: 'header' },
	  'System Location' ,
	  
	  'Address: ' + septic.systemLocation,
	  'City/Town: ' + septic.systemCity,
	  'State: ' + septic.systemState,
	  'Zip Code ' + septic.systemZip,
	  
	  '\n',
	  'System Owner',
	  'Name: ' + septic.ownerName,
	  'Address ' + septic.ownerAddress,
	  'City/Town: ' + septic.ownerCity,
	  'State: ' + septic.ownerState ,
	  'Zip Code: ' + septic.ownerZip ,
	  'Telephone Number: ' + septic.ownerTel ,
	  
	  '\n',
	  'Facility Information',
	  'Date of Pumping: ' + septic.dateOfPumping ,
	  'Quantity Pumped (gallons): ' + septic.quantityPumped ,
	  
	  '\n',
	  'Component',
	  'Cesspool: ' + septic.componentsCesspool ,
	  'Septic Tank: ' + septic.componentsSeptic,
	  'Tight Tank: ' + septic.componentsTight ,
	  'Grease Trap: ' + septic.componentsGrease ,
	  'Other: ' + septic.componentsOther ,
	  'If other, please describe: ' + septic.otherDescription ,
	  
	  '\n',
	  'Effluent Tee Filter present?',
	  'Yes: ' + septic.teeFilterPresentYes ,
	  'No: ' + septic.teeFilterPresentNo ,
	  
	  '\n',
	  'If yes, was it cleaned?',
	  'Yes: ' + septic.cleanedYes ,
	  'No: ' + septic.cleanedNo ,
	  'Observed condition of component pumped: ' + septic.condition,
	  
	  '\n',
	  'System Pumped By',
	  'Name: ' + septic.pumperName ,
	  'Company: ' + septic.pumperCompany ,
	  'Vehicle License Number: ' + septic.umperLicense ,
	  
	  '\n',
	  'Location where contents were disposed',
	  'Location: ' + septic.disposalLocation
	],
